...
function themeFunction() {
    ...
    themeButton.addEventListener("click", (e)=>{
        ...
        if(document.body.classList.contains("dark-theme")){
            saveTheme()
            darkThemeText.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-moon-fill" viewBox="0 0 16 16">
            ...
            deleteTheme()
            darkThemeText.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-sun-fill" viewBox="0 0 16 16">
